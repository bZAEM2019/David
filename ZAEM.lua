...
local info_file = io.open('./'..ZAEM..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevRio:set(ZAEM.."Rio:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevRio:sadd(ZAEM.."Rio:Groups",IdGps) 
DevRio:set(ZAEM.."Rio:Lock:Bots"..IdGps,"del") DevRio:hset(ZAEM.."Rio:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevRio:set(ZAEM..Lock..IdGps,true)
end
if v.RioConstructors then
for k,IdRioConstructors in pairs(v.RioConstructors) do
DevRio:sadd(ZAEM..'Rio:RioConstructor:'..IdGps,IdRioConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevRio:sadd(ZAEM..'Rio:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevRio:sadd(ZAEM..'Rio:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevRio:sadd(ZAEM..'Rio:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevRio:sadd(ZAEM..'Rio:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevRio:sadd(ZAEM..'Rio:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevRio:set(ZAEM.."Rio:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevRio:set(ZAEM.."Rio:Groups:Welcomes"..IdGps,v.Welcomes)   
...
var = true  
elseif tonumber(user_id) == tonumber(ZAEM) then  
var = true
elseif DevRio:sismember(ZAEM..'Rio:RioSudo:', user_id) then
var = true
elseif DevRio:sismember(ZAEM..'Rio:SecondSudo:', user_id) then
var = true  
elseif DevRio:sismember(ZAEM..'Rio:SudoBot:', user_id) then
var = true 
elseif DevRio:sismember(ZAEM..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(ZAEM..'Rio:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(ZAEM..'Rio:Constructor:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(ZAEM..'Rio:Managers:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(ZAEM..'Rio:Admins:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(ZAEM..'Rio:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local rio = (ZAEM..'Rio:Filters:'..msg.chat_id_)
if rio then
...
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevRio:get(ZAEM..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevRio:get(ZAEM..'Rio:ChText') then
local ChText = DevRio:get(ZAEM..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(ZAEM.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevRio:get(ZAEM..'yes'..data.sender_user_id_) == 'delyes' then
DevRio:del(ZAEM..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(ZAEM..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevRio:get(ZAEM..'no'..data.sender_user_id_) == 'delno' then
DevRio:del(ZAEM..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(ZAEM..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر اطردني") 
end
--     Source ZAEM     --
if DataText == '/yesdel' and DevRio:get(ZAEM..'yesdel'..data.sender_user_id_) == 'delyes' then
DevRio:del(ZAEM..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(ZAEM..'nodel'..data.sender_user_id_, 'delno')
if DevRio:sismember(ZAEM..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(ZAEM..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevRio:sismember(ZAEM..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(ZAEM..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(ZAEM..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevRio:sismember(ZAEM..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevRio:sismember(ZAEM..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ZAEM..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ZAEM..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ZAEM..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ZAEM..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ZAEM..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevRio:srem(ZAEM..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ZAEM..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ZAEM..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ZAEM..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ZAEM..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ZAEM..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevRio:get(ZAEM.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر تغير المطور الاساسي") 
DevRio:del(ZAEM.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevRio:get(ZAEM.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevRio:get(ZAEM..'nodel'..data.sender_user_id_) == 'delno' then
DevRio:del(ZAEM..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(ZAEM..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevRio:get(ZAEM.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevRio:smembers(ZAEM..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevRio:incrby(ZAEM..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevRio:del(ZAEM..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(ZAEM.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "᥀︙*صاحب الحظ* ↫ ["..UserName.."]\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(ZAEM..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(ZAEM.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevRio:del(ZAEM.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevRio:sismember(ZAEM..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevRio:srem(ZAEM..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevRio:del(ZAEM..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:srem(ZAEM..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevRio:smembers(ZAEM..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevRio:get(ZAEM..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(ZAEM..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevRio:del(ZAEM..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:del(ZAEM..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(ZAEM..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(ZAEM..'Rio:Help')
local Text = [[
...
local Help = DevRio:get(ZAEM..'Rio:Help1')
local Text = [[
...
local Help = DevRio:get(ZAEM..'Rio:Help2')
local Text = [[
᥀︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الاعدادت
...
local Help = DevRio:get(ZAEM..'Rio:Help3')
local Text = [[
᥀︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙فحص البوت
...
local Help = DevRio:get(ZAEM..'Rio:Help4')
local Text = [[
᥀︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙تنزيل الكل
...
local Help = DevRio:get(ZAEM..'Rio:Help5')
local Text = [[
᥀︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(ZAEM..'Rio:Help6')
local Text = [[
᥀︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text and DevRio:get(ZAEM.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevRio:get(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevRio:del(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevRio:del(ZAEM.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:srem(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevRio:del(ZAEM.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevRio:get(ZAEM..'Rio:NameBot') or "ديفد")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(ZAEM..'Rio:NameBot') or "ديفد")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevRio:get(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevRio:get(ZAEM.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevRio:set(ZAEM.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل الامر الجديد", 1, 'html')
DevRio:del(ZAEM.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevRio:set(ZAEM.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevRio:get(ZAEM.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevRio:get(ZAEM.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الامر", 1, 'html')
DevRio:del(ZAEM.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevRio:smembers(ZAEM.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "᥀︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevRio:get(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevRio:smembers(ZAEM.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevRio:del(ZAEM.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevRio:set(ZAEM.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(ZAEM.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
DevRio:set(ZAEM.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevRio:set(ZAEM.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevRio:smembers(ZAEM.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevRio:get(ZAEM.."Comd:New:rt:Rio:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevRio:smembers(ZAEM.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(ZAEM.."Comd:New:rt:Rio:"..v..msg.chat_id_)
DevRio:del(ZAEM.."Coomds"..msg.chat_id_)
end
...
DevRio:set(ZAEM.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevRio:sadd(ZAEM.."Coomds"..msg.chat_id_,ComdNew)  
DevRio:setex(ZAEM.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n᥀︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevRio:del(ZAEM.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حذف الصلاحيه", 1, 'html')
end
if DevRio:get(ZAEM.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, 'html')
DevRio:del(ZAEM.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevRio:get(ZAEM.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevRio:set(ZAEM.."Comd:New:rt:Rio:"..textn..msg.chat_id_,text)
...
if DevRio:sismember(ZAEM.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevRio:get(ZAEM.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
...
DevRio:set(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
DevRio:sadd(ZAEM..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)
DevRio:sadd(ZAEM..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)  
DevRio:sadd(ZAEM..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(ZAEM..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(ZAEM..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(ZAEM..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
end
...
if DevRio:sismember(ZAEM.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrrio = DevRio:get(ZAEM.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(ZAEM..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:set(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(ZAEM..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:set(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(ZAEM..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:set(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:srem(ZAEM..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:del(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(ZAEM..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:del(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(ZAEM..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:del(ZAEM.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:incr(ZAEM..'Rio:UsersMsgs'..ZAEM..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(ZAEM..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevRio:sismember(ZAEM.."Rio:Users",msg.chat_id_) then
DevRio:sadd(ZAEM.."Rio:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not DevRio:get(ZAEM..'Rio:Start:Time'..msg.sender_user_id_) then
...
local start = DevRio:get(ZAEM.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
DevRio:setex(ZAEM..'Rio:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source ZAEM     --
if not SecondSudo(msg) and not DevRio:sismember(ZAEM..'Rio:Ban:Pv',msg.sender_user_id_) and not DevRio:get(ZAEM..'Rio:Texting:Pv') then
...
DevRio:sadd(ZAEM..'Rio:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '᥀︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n᥀︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevRio:srem(ZAEM..'Rio:Ban:Pv',data.id_)  
return false  
end 
...
--     Source ZAEM     --
if text and DevRio:get(ZAEM..'Rio:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevRio:del(ZAEM..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevRio:set(ZAEM.."Rio:Start:Bot",text)  
...
DevRio:set(ZAEM..'Rio:Start:Bots'..msg.sender_user_id_,true) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Devinline:Pv',true) 
end
end
--     Source ZAEM     --
...
local ZAEMTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..ZAEMTeam[math.random(#ZAEMTeam)]..'' , 1, 'md')  
return false
end
--     Source ZAEM     --
if text and (text == 'المطور' or text == 'مطور' or text == '↫  المطور ᥀') and not DevRio:get(ZAEM..'Rio:Devinline:Pv'..msg.chat_id_) then
...
local my_ph = DevRio:get(ZAEM.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevRio:get(ZAEM..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
DevRio:incr(ZAEM..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(ZAEM.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevRio:get(ZAEM.."Rio:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevRio:sadd(ZAEM..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(ZAEM) then 
DevRio:srem(ZAEM.."Rio:Groups", msg.chat_id_) 
...
if DevRio:get(ZAEM..'Rio:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevRio:incr(ZAEM..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevRio:incr(ZAEM..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source ZAEM     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevRio:get(ZAEM..'Rio:Lock:FreeBot'..ZAEM) then
if ChatType == 'pv' then
...
DevRio:sadd(ZAEM..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(ZAEM..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevRio:sadd(ZAEM..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevRio:sadd(ZAEM.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:sadd(ZAEM.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(ZAEM.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:srem(ZAEM.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevRio:sismember(ZAEM..'Rio:Groups',msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevRio:get(ZAEM..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عدد اعضاء المجموعه اقل من ↫ *'..(DevRio:get(ZAEM..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(ZAEM.."Rio:Groups",msg.chat_id_)
DevRio:sadd(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevRio:set(ZAEM.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevRio:set(ZAEM..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source ZAEM     --
local ReFalse = tostring(msg.chat_id_)
if not DevRio:sismember(ZAEM.."Rio:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevRio:get(ZAEM..'Rio:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevRio:sadd(ZAEM..'Rio:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevRio:get(ZAEM.."Rio:Lock:Join"..msg.chat_id_) then
...
if not Manager(msg) then 
local filter = DevRio:smembers(ZAEM.."Rio:FilterPhoto"..msg.chat_id_)
...
if not Manager(msg) then 
local filter = DevRio:smembers(ZAEM.."Rio:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Manager(msg) then 
local filter = DevRio:smembers(ZAEM.."Rio:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevRio:get(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevRio:get(ZAEM..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevRio:del(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(ZAEM..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevRio:srem(ZAEM..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:srem(ZAEM..'Rio:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevRio:get(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(ZAEM.."Rio:Gif:AllRed"..msg.content_.text_)
DevRio:del(ZAEM.."Rio:Voice:AllRed"..msg.content_.text_)
DevRio:del(ZAEM.."Rio:Audio:AllRed"..msg.content_.text_)
DevRio:del(ZAEM.."Rio:Photo:AllRed"..msg.content_.text_)
DevRio:del(ZAEM.."Rio:Stecker:AllRed"..msg.content_.text_)
DevRio:del(ZAEM.."Rio:Video:AllRed"..msg.content_.text_)
DevRio:del(ZAEM.."Rio:File:AllRed"..msg.content_.text_)
DevRio:del(ZAEM.."Rio:Text:AllRed"..msg.content_.text_)
DevRio:del(ZAEM.."Rio:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source ZAEM     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevRio:get(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevRio:get(ZAEM..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(ZAEM..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙᥀︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(ZAEM..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(ZAEM..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevRio:get(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(ZAEM..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local ZAEMTeam =  DevRio:smembers(ZAEM..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..ZAEMTeam[math.random(#ZAEMTeam)]..']' , 1, 'md')  
end
end
--     Source ZAEM     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevRio:get(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevRio:get(ZAEM..'DelManagerRep'..msg.chat_id_)
DevRio:srem(ZAEM..'Rio:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(ZAEM..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ZAEM..'DelManagerRep'..msg.chat_id_)
return false
end
DevRio:del(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevRio:get(ZAEM..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevRio:set(ZAEM..'Rio:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevRio:set(ZAEM..'Rio:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevRio:set(ZAEM..'Rio:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevRio:set(ZAEM..'Rio:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevRio:set(ZAEM..'Rio:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevRio:set(ZAEM..'Rio:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevRio:set(ZAEM..'Rio:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevRio:set(ZAEM..'Rio:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevRio:get(ZAEM..'Rio:Lock:GpRed'..msg.chat_id_) then 
if DevRio:get(ZAEM..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ZAEM..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(ZAEM..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ZAEM..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(ZAEM..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ZAEM..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(ZAEM..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ZAEM..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(ZAEM..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ZAEM..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(ZAEM..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ZAEM..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(ZAEM..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ZAEM..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevRio:get(ZAEM..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function ZAEMTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(ZAEM..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(ZAEM..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
getUser(msg.sender_user_id_, ZAEMTeam)
end
end
--     Source ZAEM     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevRio:get(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevRio:get(ZAEM..'DelSudoRep')
DevRio:del(ZAEM.."Rio:Sudo:AllRed",DelSudoRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(ZAEM.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(ZAEM.."DelSudoRep")
return false
end
DevRio:del(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevRio:get(ZAEM.."Rio:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevRio:set(ZAEM.."Rio:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevRio:set(ZAEM.."Rio:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevRio:set(ZAEM.."Rio:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevRio:set(ZAEM.."Rio:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevRio:set(ZAEM.."Rio:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevRio:set(ZAEM.."Rio:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevRio:set(ZAEM.."Rio:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevRio:set(ZAEM.."Rio:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الرد الجديد', 1, 'md') 
DevRio:del(ZAEM.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(ZAEM..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevRio:get(ZAEM..'Rio:Lock:AllRed'..msg.chat_id_) then
if DevRio:get(ZAEM.."Rio:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ZAEM.."Rio:Video:AllRed"..msg.content_.text_))
end
if DevRio:get(ZAEM.."Rio:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ZAEM.."Rio:File:AllRed"..msg.content_.text_))
end
if DevRio:get(ZAEM.."Rio:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ZAEM.."Rio:Voice:AllRed"..msg.content_.text_))
end
if DevRio:get(ZAEM.."Rio:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ZAEM.."Rio:Audio:AllRed"..msg.content_.text_))
end
if DevRio:get(ZAEM.."Rio:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ZAEM.."Rio:Photo:AllRed"..msg.content_.text_))
end
if  DevRio:get(ZAEM.."Rio:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ZAEM.."Rio:Gif:AllRed"..msg.content_.text_))
end
if DevRio:get(ZAEM.."Rio:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ZAEM.."Rio:Stecker:AllRed"..msg.content_.text_))
end
if DevRio:get(ZAEM.."Rio:Text:AllRed"..msg.content_.text_) then
function ZAEMTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(ZAEM..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(ZAEM.."Rio:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevRio:sismember(ZAEM..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevRio:sadd(ZAEM..'Rio:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source ZAEM     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= ZAEM then
floods = DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevRio:get(ZAEM.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevRio:setex(ZAEM.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source ZAEM     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(ZAEM) then
DevRio:set(ZAEM..'Rio:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevRio:get(ZAEM..'Rio:PinnedMsg'..msg.chat_id_)
if pin_id and DevRio:get(ZAEM..'Rio:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevRio:get(ZAEM..'Rio:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevRio:del(ZAEM..'Rio:viewget'..msg.sender_user_id_)
else
...
if DevRio:get(ZAEM..'Rio:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevRio:get(ZAEM..'Rio:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevRio:get(ZAEM..'Rio:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevRio:get(ZAEM..'Rio:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevRio:get(ZAEM..'Rio:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevRio:get(ZAEM..'Rio:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevRio:get(ZAEM..'Rio:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevRio:get(ZAEM..'Rio:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevRio:get(ZAEM..'Rio:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(ZAEM..'Rio:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevRio:get(ZAEM..'Rio:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source ZAEM     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevRio:get(ZAEM..'Rio:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(ZAEM..'Rio:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevRio:get(ZAEM..'Rio:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if DevRio:get(ZAEM.."Rio:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source ZAEM     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevRio:get(ZAEM..'Rio:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = ZAEM,offset_ = 0,limit_ = 1},function(extra,rio,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(ZAEM) then 
if DevRio:sismember(ZAEM..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n᥀︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n᥀︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n᥀︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(ZAEM.."Rio:Text:BotWelcome") then RioText = DevRio:get(ZAEM.."Rio:Text:BotWelcome") else RioText = "᥀︙مرحبا انا بوت اسمي "..NameBot.."\n᥀︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevRio:get(ZAEM.."Rio:Photo:BotWelcome") then RioPhoto = DevRio:get(ZAEM.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
if DevRio:get(ZAEM..'Rio:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source ZAEM     --
...
if DevRio:get(ZAEM..'Rio:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(ZAEM..'Rio:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(ZAEM..'Rio:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevRio:get(ZAEM..'Rio:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(ZAEM..'Rio:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(ZAEM..'Rio:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevRio:get(ZAEM..'Rio:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevRio:get(ZAEM..'Rio:Spam:Text'..msg.chat_id_))
end
if DevRio:get(ZAEM..'Rio:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source ZAEM     --
if DevRio:get(ZAEM.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"᥀︙تم الغاء حفظ الرابط")       
DevRio:del(ZAEM.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevRio:set(ZAEM.."Rio:Groups:Links"..msg.chat_id_,Link)
...
if DevRio:get('ZAEMTeam:'..ZAEM.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('ZAEMTeam:'..ZAEM..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('ZAEMTeam:'..ZAEM.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('ZAEMTeam:'..ZAEM.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('ZAEMTeam:'..ZAEM..'id:user'..msg.chat_id_)  
DevRio:incrby(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "᥀︙تم اضافة "..numadded..' رساله', 1, 'md')
DevRio:del('ZAEMTeam:'..ZAEM..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevRio:get('ZAEMTeam:'..ZAEM.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('ZAEMTeam:'..ZAEM..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('ZAEMTeam:'..ZAEM.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('ZAEMTeam:'..ZAEM.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('ZAEMTeam:'..ZAEM..'ids:user'..msg.chat_id_)  
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevRio:get(ZAEM.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevRio:get(ZAEM.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","᥀︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevRio:get(ZAEM.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevRio:get(ZAEM.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevRio:get(ZAEM.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevRio:smembers(ZAEM..'Rio:Groups') 
local BotName = (DevRio:get(ZAEM.."Rio:NameBot") or 'ديفد')
local GetJson = '{"BotId": '..ZAEM..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevRio:get(ZAEM.."Rio:Groups:Links"..v)
Welcomes = DevRio:get(ZAEM..'Rio:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
RioConstructors = DevRio:smembers(ZAEM..'Rio:RioConstructor:'..v)
Constructors = DevRio:smembers(ZAEM..'Rio:BasicConstructor:'..v)
BasicConstructors = DevRio:smembers(ZAEM..'Rio:Constructor:'..v)
Managers = DevRio:smembers(ZAEM..'Rio:Managers:'..v)
Admis = DevRio:smembers(ZAEM..'Rio:Admins:'..v)
Vips = DevRio:smembers(ZAEM..'Rio:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..ZAEM..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..ZAEM..'.json', '᥀︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..ZAEM..'.json')
end
...
--     Source ZAEM     --
if DevRio:get(ZAEM.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"᥀︙يوجد فقط ( 6 ) اختيارات\n᥀︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevRio:get(ZAEM.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(ZAEM.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'᥀︙*المحيبس باليد رقم* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevRio:get(ZAEM..'DevRio4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "᥀︙تم الغاء الامر")
DevRio:del(ZAEM..'DevRio4'..msg.sender_user_id_)
return false  end 
DevRio:del(ZAEM..'DevRio4'..msg.sender_user_id_)
...
DevRio:set(ZAEM..'Rio:ChId',data.id_)
else
...
--     Source ZAEM     --
if DevRio:get(ZAEM.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevRio:del(ZAEM.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
DevRio:del(ZAEM.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevRio:set(ZAEM.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ كليشة المطور", 1, "md")
end
if DevRio:get(ZAEM..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevRio:del(ZAEM..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ اسم البوت ', 1, 'html')
DevRio:del(ZAEM..'Rio:NameBot'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:NameBot', text)
return false 
end
--     Source ZAEM     --
if text == "الرابط" then
if not DevRio:get(ZAEM..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(ZAEM.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(ZAEM.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source ZAEM     --
if text == "الرابط" then
if not DevRio:get(ZAEM.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(ZAEM.."Private:Group:Link"..msg.chat_id_) 
...
NameBot = (DevRio:get(ZAEM..'Rio:NameBot') or 'ديفد')
local ZAEMTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevRio2 = math.random(#ZAEMTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(ZAEM..'Rio:NameBot') or 'ديفد') 
local ZAEMTeam = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#ZAEMTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(ZAEM..'Rio:NameBot') or 'ديفد') then 
NameBot = (DevRio:get(ZAEM..'Rio:NameBot') or 'ديفد')
...
if tonumber((DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لم تربح اي نقطه\n᥀︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد النقاط التي ربحتها ↫ '..(DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevRio:del(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع نقاطك', 1, 'md') end
--     Source ZAEM     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ᥀' and ChCheck(msg) then
if not DevRio:get(ZAEM..'Rio:Lock:Games'..msg.chat_id_) then
DevRio2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ZAEM..'Rio:GameNum'..msg.chat_id_,name)
DevRio:del(ZAEM..'Rio:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
ZAEMTeam = '᥀︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then 
ZAEMTeam = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(ZAEM..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
ZAEMTeam = '᥀︙اول واحد يرتبها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then
...
if not DevRio:get(ZAEM..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevRio:set(ZAEM.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevRio:setex(ZAEM.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
ZAEMTeam = '᥀︙اول واحد يحلها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ZAEM..'Rio:GameNum2'..msg.chat_id_,name)
DevRio:del(ZAEM..'Rio:Games:Ids'..msg.chat_id_)
...
ZAEMTeam = '᥀︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum2'..msg.chat_id_) and not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ZAEM..'Rio:GameNum3'..msg.chat_id_,name)
DevRio:del(ZAEM..'Rio:Games:Ids'..msg.chat_id_)
...
ZAEMTeam = '᥀︙ما هو عكس كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum3'..msg.chat_id_) and not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevRio2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ZAEM..'Rio:GameNum4'..msg.chat_id_,name)
DevRio:del(ZAEM..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
ZAEMTeam = '᥀︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum4'..msg.chat_id_) and not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ZAEM..'Rio:GameNum5'..msg.chat_id_,name)
DevRio:del(ZAEM..'Rio:Games:Ids'..msg.chat_id_)
...
ZAEMTeam = '᥀︙اكمل المثال التالي ↫ ['..name..']'
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum5'..msg.chat_id_) then
if not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(ZAEM..'Rio:GameNum5'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ZAEM..'Rio:GameNum6'..msg.chat_id_,name)
DevRio:del(ZAEM..'Rio:Games:Ids'..msg.chat_id_)
...
ZAEMTeam = '᥀︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum6'..msg.chat_id_) then
if not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(ZAEM..'Rio:GameNum6'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ZAEM..'Rio:GameNum7'..msg.chat_id_,name)
DevRio:del(ZAEM..'Rio:Games:Ids'..msg.chat_id_)
...
ZAEMTeam = '᥀︙ما معنى كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md')
return false
end end
if text == DevRio:get(ZAEM..'Rio:GameNum7'..msg.chat_id_) then
if not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(ZAEM..'Rio:GameNum7'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ZAEM..'Rio:GameNum8'..msg.chat_id_,name)
DevRio:del(ZAEM..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(ZAEM..'Rio:GameNum8'..msg.chat_id_) then
if not DevRio:get(ZAEM..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(ZAEM..'Rio:GameNum8'..msg.chat_id_)
...
--     Source ZAEM     --
if DevRio:get(ZAEM.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"᥀︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevRio:get(ZAEM.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(ZAEM..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(ZAEM.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevRio:incrby(ZAEM..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevRio:get(ZAEM..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevRio:del(ZAEM..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(ZAEM.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n᥀︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevRio:get(ZAEM..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevRio:get(ZAEM..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevRio:set(ZAEM.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n᥀︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevRio:setex(ZAEM.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source ZAEM     --
...
if not DevRio:get(ZAEM..'Rio:Lock:Games'..msg.chat_id_) then
DevRio:del(ZAEM.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:del(ZAEM..'Rio:ListRolet'..msg.chat_id_)  
DevRio:setex(ZAEM.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevRio:get(ZAEM.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "᥀︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevRio:set(ZAEM.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '᥀︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n᥀︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevRio:del(ZAEM.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevRio:get(ZAEM.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevRio:sismember(ZAEM..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevRio:sadd(ZAEM..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevRio:get(ZAEM.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevRio:scard(ZAEM..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevRio:del(ZAEM.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:setex(ZAEM.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevRio0 = (DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevRio:incrby(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevRio0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙تم بيع '..(DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n᥀︙كل نقطه تساوي 50 رساله', 'md')
DevRio:del(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source ZAEM     --
...
DevRio:sadd(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevRio:sadd(ZAEM..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevRio:get(ZAEM.."Rio:Left:Bot"..ZAEM) then
...
local msguser = tonumber(DevRio:get(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevRio:get(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevRio:get(ZAEM..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevRio:setex(ZAEM..'DevRio4'..msg.sender_user_id_,360,true)
...
function ZAEMTeam(extra,result,success)
if DevRio:get(ZAEM.."Rio:Send:Bot"..ZAEM) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"᥀︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevRio:smembers(ZAEM.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevRio:smembers(ZAEM.."Rio:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n᥀︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),ZAEMTeam)
end
end
--     Source ZAEM     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevRio:set(ZAEM..'Rio:viewget'..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙حسنا قم باعادة توجيه للمنشور الذي تريدني حساب مشاهداته', 1, 'md')
end
--     Source ZAEM     --
if text == "سورس" or text == "السورس" or text == "يا سورس" or text == "↫  السورس ᥀" ZAEMthen
Text = [[
Welcome To Source
᥀︙[ZAEM Team](https://t.me/L9L9L)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/L9L9L"}},
{{text = '᥀ Developer',url="t.me/tsttt"},{text = '᥀ Tws ZAEM',url="https://t.me/W555Bot"}},{{text= '᥀ Support Source .',url="https://t.me/joinchat/L980Ig8wQnAyN2Vi"}}
}
local msg_id = msg.id_/2097152/0.5
...
if DevRio:get(ZAEM.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(ZAEM..'yes'..msg.sender_user_id_, 'delyes')
DevRio:set(ZAEM..'no'..msg.sender_user_id_, 'delno')
...
DevRio:set(ZAEM.."Rio:Kick:Me"..msg.chat_id_, true)
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevRio:del(ZAEM.."Rio:Kick:Me"..msg.chat_id_)
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
end
--     Source ZAEM     --
if text == "نزلني" and ChCheck(msg) then
if DevRio:get(ZAEM.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(ZAEM..'yesdel'..msg.sender_user_id_, 'delyes')
DevRio:set(ZAEM..'nodel'..msg.sender_user_id_, 'delno')
...
DevRio:set(ZAEM.."Rio:Del:Me"..msg.chat_id_, true)
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevRio:del(ZAEM.."Rio:Del:Me"..msg.chat_id_)
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
end
--     Source ZAEM     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevRio:get(ZAEM..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "᥀︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevRio:get(ZAEM..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevRio:get(ZAEM..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevRio:get(ZAEM..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevRio:get(ZAEM..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevRio:get(ZAEM..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevRio:get(ZAEM.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevRio:get(ZAEM.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevRio:setex(ZAEM..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
get_msg = DevRio:get(ZAEM.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source ZAEM     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(ZAEM..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(ZAEM..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevRio:del(ZAEM..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(ZAEM..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source ZAEM     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevRio:get(ZAEM..'Rio:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function ZAEMTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(ZAEM) then  
...
if DevRio:sismember(ZAEM.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local ZAEMTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md') 
local ZAEMTeam = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..ZAEMTeam[math.random(#ZAEMTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,ZAEMTeam)
end
end
--     Source ZAEM     --
...
if tonumber(result.sender_user_id_) == tonumber(ZAEM) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if DevRio:sismember(ZAEM.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local ZAEMTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md') 
local ZAEMTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..ZAEMTeam[math.random(#ZAEMTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local ZAEMTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md') 
local ZAEMTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..ZAEMTeam[math.random(#ZAEMTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local ZAEMTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md') 
local ZAEMTeam = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..ZAEMTeam[math.random(#ZAEMTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local ZAEMTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ZAEMTeam, 1, 'md') 
local ZAEMTeam = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..ZAEMTeam[math.random(#ZAEMTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevRio:sismember(ZAEM..'Rio:RioSudo:',result.sender_user_id_) then
riosudo = 'المطورين الاساسيين • ' else riosudo = '' end
if DevRio:sismember(ZAEM..'Rio:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(ZAEM..'Rio:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(ZAEM..'Rio:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(ZAEM..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(ZAEM..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(ZAEM..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(ZAEM..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevRio:srem(ZAEM..'Rio:RioSudo:', result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:SecondSudo:', result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:SudoBot:', result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(ZAEM..'Rio:RioSudo:',result.id_) then
Riosudo = 'المطورين الاساسيين • ' else Riosudo = '' end
if DevRio:sismember(ZAEM..'Rio:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(ZAEM..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(ZAEM..'Rio:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(ZAEM..'Rio:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(ZAEM..'Rio:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(ZAEM..'Rio:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(ZAEM..'Rio:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevRio:srem(ZAEM..'Rio:RioSudo:', result.id_)
DevRio:srem(ZAEM..'Rio:SecondSudo:', result.id_)
DevRio:srem(ZAEM..'Rio:SudoBot:', result.id_)
DevRio:srem(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevRio:srem(ZAEM..'Rio:Constructor:'..msg.chat_id_,result.id_)
DevRio:srem(ZAEM..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:srem(ZAEM..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:srem(ZAEM..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:srem(ZAEM..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudo' then
DevRio:srem(ZAEM..'Rio:SecondSudo:', result.id_)
DevRio:srem(ZAEM..'Rio:SudoBot:', result.id_)
DevRio:srem(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ZAEM..'Rio:RioSudo:',result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ZAEM..'Rio:RioSudo:',result.id_)
...
DevRio:sadd(ZAEM..'Rio:RioSudo:',user)
...
DevRio:srem(ZAEM..'Rio:RioSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(ZAEM..'Rio:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(ZAEM..'Rio:SecondSudo:',result.id_)
...
DevRio:sadd(ZAEM..'Rio:SecondSudo:',user)
...
DevRio:srem(ZAEM..'Rio:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(ZAEM..'Rio:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(ZAEM..'Rio:SudoBot:',result.id_)
...
DevRio:sadd(ZAEM..'Rio:SudoBot:',user)
...
DevRio:srem(ZAEM..'Rio:SudoBot:',user)
...
DevRio:sadd(ZAEM..'Rio:RioConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(ZAEM..'Rio:RioConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ZAEM..'Rio:RioConstructor:'..msg.chat_id_,user)
...
DevRio:srem(ZAEM..'Rio:RioConstructor:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(ZAEM..'Rio:RioConstructor:'..msg.chat_id_,result.id_)
...
DevRio:srem(ZAEM..'Rio:RioConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not RioConstructor(msg) and DevRio:get(ZAEM.."Rio:Lock:ProSet"..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevRio:sadd(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:srem(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:sadd(ZAEM..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ZAEM..'Rio:Constructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ZAEM..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:srem(ZAEM..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:sadd(ZAEM..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:srem(ZAEM..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:sadd(ZAEM..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ZAEM..'Rio:Cleaner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ZAEM..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:srem(ZAEM..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:sadd(ZAEM..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:srem(ZAEM..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:sadd(ZAEM..'Rio:VipMem:'..msg.chat_id_,user)
...
DevRio:srem(ZAEM..'Rio:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..ZAEM)
local GetInfo = JSON.decode(Check)
...
ZAEMTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,ZAEMTeam[math.random(#ZAEMTeam)])
end
--     Source ZAEM     --
...
DevRio:del(ZAEM.."Rio:Lock:ProSet"..msg.chat_id_)
...
DevRio:set(ZAEM.."Rio:Lock:ProSet"..msg.chat_id_,"true")
...
if not Constructor(msg) and DevRio:get(ZAEM.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(ZAEM..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not RioConstructor(msg) and DevRio:get(ZAEM.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(ZAEM..'Rio:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevRio:sadd(ZAEM..'Rio:Ban:'..msg.chat_id_, user)
...
DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_, result.id_)
...
DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_, user)
...
if not RioConstructor(msg) and DevRio:get(ZAEM.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(ZAEM..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(ZAEM..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(ZAEM..'Rio:Muted:'..msg.chat_id_, user)
...
if not DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if not DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_, user)
...
DevRio:sadd(ZAEM..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:sadd(ZAEM..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:sadd(ZAEM..'Rio:Tkeed:'..msg.chat_id_, user)
...
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_, user)
...
if DevRio:sismember(ZAEM..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(ZAEM..'Rio:SecondSudo:',result.sender_user_id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(ZAEM..'Rio:BanAll:', result.sender_user_id_)
...
if DevRio:sismember(ZAEM..'Rio:RioSudo:',result.id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(ZAEM..'Rio:SecondSudo:',result.id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(ZAEM..'Rio:BanAll:', result.id_)
...
if tonumber(user) == tonumber(ZAEM) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if DevRio:sismember(ZAEM..'Rio:RioSudo:',user) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(ZAEM..'Rio:SecondSudo:',user) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevRio:sadd(ZAEM..'Rio:BanAll:', user)
...
DevRio:sadd(ZAEM..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ZAEM..'Rio:MuteAll:', result.id_)
...
DevRio:sadd(ZAEM..'Rio:MuteAll:', user)
...
DevRio:srem(ZAEM..'Rio:BanAll:', result.sender_user_id_)
DevRio:srem(ZAEM..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:srem(ZAEM..'Rio:BanAll:', result.id_)
DevRio:srem(ZAEM..'Rio:MuteAll:', result.id_)
...
DevRio:srem(ZAEM..'Rio:BanAll:', user)
DevRio:srem(ZAEM..'Rio:MuteAll:', user)
...
DevRio:setex(ZAEM.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevRio:get(ZAEM.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'᥀︙تم الغاء امر تغير المطور الاساسي')
DevRio:del(ZAEM.."Rio:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevRio:del(ZAEM.."Rio:EditDev"..msg.sender_user_id_)
DevRio:set(ZAEM.."Rio:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source ZAEM     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevRio:get(ZAEM..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevRio:sismember(ZAEM..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه في قائمة المطايه") 
DevRio:sadd(ZAEM..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source ZAEM     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevRio:get(ZAEM..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevRio:sismember(ZAEM..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مطي ليتم تنزيله") 
else
DevRio:srem(ZAEM..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:set('ZAEMTeam:'..ZAEM..'id:user'..msg.chat_id_,TXT)  
DevRio:setex('ZAEMTeam:'..ZAEM.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevRio:del(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevRio:incrby(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevRio:set('ZAEMTeam:'..ZAEM..'ids:user'..msg.chat_id_,TXT)  
DevRio:setex('ZAEMTeam:'..ZAEM.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevRio:incrby(ZAEM..'Rio:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevRio:get(ZAEM..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(ZAEM.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevRio:sadd(ZAEM.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
if DevRio:get(ZAEM..'Rio:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(ZAEM.."Rio:cleanernum"..msg.chat_id_, msg.id_) else DevRio:sadd(ZAEM.."Rio:cleanernum"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevRio:sismember(ZAEM.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevRio:set(ZAEM..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevRio:smembers(ZAEM..'Rio:VipMem:'..msg.chat_id_)
text = "᥀︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ZAEM..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ZAEM..rio)
text = "᥀︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ZAEM..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ZAEM..'Rio:Managers:'..msg.chat_id_)
text = "᥀︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ZAEM..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ZAEM..'Rio:Cleaner:'..msg.chat_id_)
text = "᥀︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ZAEM..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ZAEM..'Rio:Constructor:'..msg.chat_id_)
text = "᥀︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ZAEM..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ZAEM..'Rio:RioConstructor:'..msg.chat_id_)
text = "᥀︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ZAEM..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_)
...
local List = DevRio:smembers(ZAEM..'Rio:Muted:'..msg.chat_id_)
...
local List = DevRio:smembers(ZAEM..'Rio:Tkeed:'..msg.chat_id_)
text = "᥀︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ZAEM..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ZAEM..'Rio:Ban:'..msg.chat_id_)
...
local List = DevRio:hkeys(ZAEM..'Rio:Filters:'..msg.chat_id_)
text = "᥀︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevRio:smembers(ZAEM..'User:Donky:'..msg.chat_id_)
...
local List = DevRio:smembers(ZAEM..'Rio:RioSudo:')
...
local List = DevRio:smembers(ZAEM..'Rio:SecondSudo:')
...
local BanAll = DevRio:smembers(ZAEM..'Rio:BanAll:')
local MuteAll = DevRio:smembers(ZAEM..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevRio:smembers(ZAEM..'Rio:SudoBot:')
text = "᥀︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevRio:get(ZAEM..'Rio:Sudos'..v) 
local username = DevRio:get(ZAEM..'Save:UserName'..v)
if username then
...
DevRio:sadd(ZAEM.."Rio:RioConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevRio:srem(ZAEM.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:srem(ZAEM.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:srem(ZAEM.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevRio:get(ZAEM..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevRio:get(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevRio:sismember(ZAEM..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(ZAEM..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(ZAEM..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(ZAEM..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(ZAEM..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(ZAEM..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevRio:sismember(ZAEM..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(ZAEM..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(ZAEM..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(ZAEM..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(ZAEM..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(ZAEM..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevRio:sismember(ZAEM..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(ZAEM..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(ZAEM..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(ZAEM..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(ZAEM..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(ZAEM..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(ZAEM..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(ZAEM..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(ZAEM..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(ZAEM..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevRio:sismember(ZAEM..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(ZAEM..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(ZAEM..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(ZAEM..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(ZAEM..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الحظر العام ↫ '..banall..'\n᥀︙الكتم العام ↫ '..muteall..'\n᥀︙الحظر ↫ '..banned..'\n᥀︙الكتم ↫ '..muted..'\n᥀︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ZAEM..'Rio:BanAll:',result.sender_user_id_) DevRio:srem(ZAEM..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_,user) DevRio:srem(ZAEM..'Rio:BanAll:',user) DevRio:srem(ZAEM..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_,result.id_) DevRio:srem(ZAEM..'Rio:BanAll:',result.id_) DevRio:srem(ZAEM..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(ZAEM..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(ZAEM..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevRio:set(ZAEM.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevRio:set("ZAEM:New:id:"..ZAEM..msg.sender_user_id_,'ZAEMTeam')
return "ZAEMTeam"
end
if text and DevRio:get("ZAEM:New:id:"..ZAEM..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("ZAEM:New:id:"..ZAEM..msg.sender_user_id_)
return false
end
DevRio:del("ZAEM:New:id:"..ZAEM..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevRio:set(ZAEM.."Rio:AllIds:Text",text)
return false
end
...
DevRio:del(ZAEM.."Rio:AllIds:Text")
end
end
--     Source ZAEM     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevRio:set("ZAEM:New:id:"..ZAEM..msg.chat_id_..msg.sender_user_id_,'ZAEMTeam')
return "ZAEMTeam"
end
if text and Manager(msg) and DevRio:get("ZAEM:New:id:"..ZAEM..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("ZAEM:New:id:"..ZAEM..msg.chat_id_..msg.sender_user_id_)
return false
end
DevRio:del("ZAEM:New:id:"..ZAEM..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الكليشه الجديده', 1, 'md')
DevRio:set(ZAEM.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف كليشة الايدي")  
DevRio:del(ZAEM.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source ZAEM     --
if msg.reply_to_message_id_ ~= 0 then
...
function ZAEMTeam(extra,rio,success)
...
local msgsday = DevRio:get(ZAEM..'Rio:UsersMsgs'..ZAEM..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevRio:get(ZAEM..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(ZAEM..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevRio:get(ZAEM..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevRio:get(ZAEM..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevRio:get(ZAEM..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevRio:get(ZAEM..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevRio:get(ZAEM.."Rio:AllIds:Text") then
newpicid = DevRio:get(ZAEM.."Rio:AllIds:Text")
...
if not DevRio:get(ZAEM.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevRio:get(ZAEM.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevRio:get(ZAEM.."Rio:AllIds:Text") then
newallid = DevRio:get(ZAEM.."Rio:AllIds:Text")
...
if DevRio:get(ZAEM.."Rio:AllIds:Text") then
notpicid = DevRio:get(ZAEM.."Rio:AllIds:Text")
...
if not DevRio:get(ZAEM..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التعديل")  
DevRio:set(ZAEM..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevRio:set(ZAEM.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevRio:hset(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevRio:hset(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevRio:hset(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevRio:get(ZAEM..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevRio:set(ZAEM.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التثبيت")  
DevRio:set(ZAEM..'Rio:Lock:Pin'..msg.chat_id_,true)
DevRio:sadd(ZAEM.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevRio:hset(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevRio:hset(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevRio:get(ZAEM..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevRio:get(ZAEM..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالتاكيد معطل ', 1, 'md')
else
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source ZAEM     --
...
DevRio:setex(ZAEM.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevRio:get(ZAEM.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevRio:set(ZAEM.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevRio:get(ZAEM..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevRio:del(ZAEM..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(ZAEM..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevRio:set(ZAEM..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevRio:set(ZAEM..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف الترحيب")  
DevRio:del(ZAEM..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevRio:get(ZAEM..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source ZAEM     --
if DevRio:get(ZAEM..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء حفظ الوصف", 1, 'md')
DevRio:del(ZAEM..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(ZAEM..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(ZAEM..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevRio:set(ZAEM.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevRio:get(ZAEM.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر المنع', 1, 'md')
DevRio:del(ZAEM.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم منع الكلمه ↫ "..text, 1, 'html')
DevRio:del(ZAEM.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevRio:hset(ZAEM..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الكلمه الان", 1, 'md') 
DevRio:set(ZAEM.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevRio:get(ZAEM.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الغاء المنع', 1, 'md')
DevRio:del(ZAEM.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevRio:hget(ZAEM..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevRio:del(ZAEM.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevRio:hdel(ZAEM..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevRio:scard(ZAEM.."Rio:Groups") local users = DevRio:scard(ZAEM.."Rio:Users") 
...
local users = DevRio:scard(ZAEM.."Rio:Users")
...
local gps = DevRio:scard(ZAEM.."Rio:Groups")
...
if not DevRio:get(ZAEM..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevRio:setex(ZAEM..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevRio:smembers(ZAEM.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevRio:srem(ZAEM.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevRio:smembers(ZAEM.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevRio:srem(ZAEM.."Rio:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = ZAEM, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد الكروبات الان ↫ { '..#group..' }'..ZAEMgp1..ZAEMgp2..'\n᥀︙العدد الحقيقي الان  ↫ ( '..ZAEMgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:CleanNum'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:CleanNum'..msg.chat_id_) 
end
...
DevRio:set(ZAEM..'Rio:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevRio:get(ZAEM..'Rio:Lock:CleanNum'..msg.chat_id_) then
if DevRio:get(ZAEM..'Rio:CleanNum'..msg.chat_id_) then CleanNum = DevRio:get(ZAEM..'Rio:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevRio:scard(ZAEM.."Rio:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevRio:smembers(ZAEM.."Rio:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(ZAEM.."Rio:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevRio:get(ZAEM..'Rio:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevRio:scard(ZAEM.."Rio:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد الميديا ↫ "..M.."\n᥀︙الحذف التلقائي ↫ "..(DevRio:get(ZAEM..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
--     Source ZAEM     --
if text == "تفعيل امسح" and Constructor(msg) ZAEMthen
local ZAEMTEAM = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTEAM, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) ZAEMthen
local ZAEMTEAM = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTEAM, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevRio:get(ZAEM..'Rio:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevRio:scard(ZAEM.."Rio:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevRio:del(ZAEM.."Rio:cleaner"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
if DevRio:get(ZAEM..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التعديل")  
DevRio:del(ZAEM..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
...
DevRio:del(ZAEM.."Rio:Lock:Bots"..msg.chat_id_)  
end
if UnLockText[2] == "التكرار" then 
DevRio:hdel(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevRio:get(ZAEM..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التثبيت")  
DevRio:del(ZAEM..'Rio:Lock:Pin'..msg.chat_id_)
DevRio:srem(ZAEM.."Rio:Lock:Pinpin",msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Text'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevRio:get(ZAEM..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح الكلايش")  
DevRio:del(ZAEM..'Rio:Lock:Spam'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Join'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Videos'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Document'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Inline'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Markdown'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Gifs'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Music'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Voice'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Links'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Location'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Tags'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Hashtak'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Contact'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:WebLinks'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Arabic'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:English'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:TagServr'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Stickers'..msg.chat_id_)
else
...
DevRio:del(ZAEM..'Rio:Lock:Forwards'..msg.chat_id_)
else
...
DevRio:set(ZAEM.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Rio:Lock:Links','Rio:Lock:Contact','Rio:Lock:Forwards','Rio:Lock:Videos','Rio:Lock:Gifs','Rio:Lock:EditMsgs','Rio:Lock:Stickers','Rio:Lock:Farsi','Rio:Lock:Spam','Rio:Lock:WebLinks','Rio:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevRio:set(ZAEM..Lock..msg.chat_id_,true)
end
...
DevRio:del(ZAEM..UnLock..msg.chat_id_)
end
...
DevRio:del(ZAEM..'Rio:Lock:Fshar'..msg.chat_id_) DevRio:del(ZAEM..'Rio:Lock:Taf'..msg.chat_id_) DevRio:del(ZAEM..'Rio:Lock:Kfr'..msg.chat_id_) 
DevRio:set(ZAEM.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevRio:set(ZAEM..'Rio:Lock:Fshar'..msg.chat_id_,true) DevRio:set(ZAEM..'Rio:Lock:Taf'..msg.chat_id_,true) DevRio:set(ZAEM..'Rio:Lock:Kfr'..msg.chat_id_,true) DevRio:hdel(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevRio:set(ZAEM..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
...
DevRio:set(ZAEM.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
...
DevRio:set(ZAEM.."Rio:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(ZAEM.."Rio:Constructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(ZAEM.."Rio:Managers:Rd"..msg.chat_id_,Text) 
...
DevRio:set(ZAEM.."Rio:Admins:Rd"..msg.chat_id_,Text)
...
DevRio:set(ZAEM.."Rio:VipMem:Rd"..msg.chat_id_,Text)
...
DevRio:set(ZAEM.."Rio:Cleaner:Rd"..msg.chat_id_,Text)
...
DevRio:set(ZAEM.."Rio:mem:Rd"..msg.chat_id_,Text)
...
DevRio:del(ZAEM.."Rio:mem:Rd"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:Cleaner:Rd"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:VipMem:Rd"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:Admins:Rd"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:Managers:Rd"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:Constructor:Rd"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:BasicConstructor:Rd"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source ZAEM     --
...
if tonumber(admins[i].user_id_) ~= tonumber(ZAEM) then
...
DevRio:del(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف المنشئين")  
DevRio:del(ZAEM..'Rio:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف المدراء")  
DevRio:del(ZAEM..'Rio:Managers:'..msg.chat_id_)
end 
...
DevRio:srem(ZAEM..'Rio:Tkeed:'..msg.chat_id_, v)
end 
...
DevRio:del(ZAEM..'Rio:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف قوائم المنع")  
DevRio:del(ZAEM..'Rio:Filters:'..msg.chat_id_)
DevRio:del(ZAEM.."Rio:FilterAnimation"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:FilterPhoto"..msg.chat_id_)
DevRio:del(ZAEM.."Rio:FilterSteckr"..msg.chat_id_)
end
...
DevRio:del(ZAEM..'Rio:Ban:'..msg.chat_id_) DevRio:del(ZAEM..'Rio:Admins:'..msg.chat_id_) DevRio:del(ZAEM..'User:Donky:'..msg.chat_id_) DevRio:del(ZAEM..'Rio:VipMem:'..msg.chat_id_) DevRio:del(ZAEM..'Rio:Filters:'..msg.chat_id_) DevRio:del(ZAEM..'Rio:Muted:'..msg.chat_id_)
...
local basicconstructor = DevRio:smembers(ZAEM..'Rio:BasicConstructor:'..msg.chat_id_)
local constructor = DevRio:smembers(ZAEM..'Rio:Constructor:'..msg.chat_id_)
local Managers = DevRio:smembers(ZAEM..'Rio:Managers:'..msg.chat_id_)
local admins = DevRio:smembers(ZAEM..'Rio:Admins:'..msg.chat_id_)
local vipmem = DevRio:smembers(ZAEM..'Rio:VipMem:'..msg.chat_id_)
local donky = DevRio:smembers(ZAEM..'User:Donky:'..msg.chat_id_)
...
spam_c = DevRio:get(ZAEM..'Rio:Spam:Text'..msg.chat_id_)
end
--     Source ZAEM     --
if DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source ZAEM     --
if DevRio:get(ZAEM.."Rio:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevRio:get(ZAEM.."Rio:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevRio:get(ZAEM.."Rio:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source ZAEM     --
if DevRio:get(ZAEM..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevRio:get(ZAEM..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevRio:get(ZAEM.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevRio:get(ZAEM..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevRio:get(ZAEM..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevRio:get(ZAEM..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevRio:get(ZAEM..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevRio:hget(ZAEM.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source ZAEM     --
...
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevRio:get(ZAEM..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source ZAEM     --
if DevRio:get(ZAEM..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevRio:del(ZAEM..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(ZAEM..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:rules'..msg.chat_id_,text)
...
DevRio:set(ZAEM..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevRio:get(ZAEM..'Rio:rules'..msg.chat_id_)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الزخرفه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(ZAEM..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(ZAEM..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(ZAEM..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevRio:setex(ZAEM.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الابراج بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(ZAEM..'Rio:Brg:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(ZAEM..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevRio:set(ZAEM..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(ZAEM..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(ZAEM..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevRio:set(ZAEM..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ᥀" and DevRio:get(ZAEM..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(ZAEM..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ZAEM..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ᥀" and DevRio:get(ZAEM..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(ZAEM..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ZAEM..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ᥀" and DevRio:get(ZAEM..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(ZAEM..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ZAEM..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ᥀" and DevRio:get(ZAEM..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(ZAEM..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ZAEM..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ᥀" and DevRio:get(ZAEM..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(ZAEM..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ZAEM..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ᥀" and DevRio:get(ZAEM..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevRio:del(ZAEM..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(ZAEM..'Rio:Age:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Mean:Rio'..msg.chat_id_) 
end
...
if text and text:match("^معنى الاسم (.*)$") or text and text:match("^معنى اسم (.*)$") ZAEMthen 
...
--     Source ZAEM     --
if text == "تفعيل متحركه" and Manager(msg) or text == "تفعيل المتحركه" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) or text == "تعطيل المتحركه" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(ZAEM..'Rio:gif:Rio'..msg.chat_id_) ZAEMthen
...
--     Source ZAEM     --
if text == "تفعيل ميمز" and Manager(msg) or text == "تفعيل الميمز" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) or text == "تعطيل الميمز" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(ZAEM..'Rio:memz:Rio'..msg.chat_id_) ZAEMthen
...
--     Source ZAEM     --
if text == "تفعيل غنيلي" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevRio:get(ZAEM..'Rio:Audios:Rio'..msg.chat_id_) ZAEMthen
...
--     Source ZAEM     --
if text == "تفعيل الاغاني" and Manager(msg) or text == "تفعيل اغنيه" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) or text == "تعطيل اغنيه" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(ZAEM..'Rio:mp3:Rio'..msg.chat_id_) ZAEMthen
...
--     Source ZAEM     --
if text == "تفعيل ريمكس" and Manager(msg) or text == "تفعيل الريمكس" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) or text == "تعطيل الريمكس" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(ZAEM..'Rio:Remix:Rio'..msg.chat_id_) ZAEMthen
...
--     Source ZAEM     --
if text == "تفعيل صوره" and Manager(msg) or text == "تفعيل الصوره" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) or text == "تعطيل الصوره" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(ZAEM..'Rio:Photo:Rio'..msg.chat_id_) ZAEMthen
...
--     Source ZAEM     --
if text == "تفعيل انمي" and Manager(msg) or text == "تفعيل الانمي" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) or text == "تعطيل الانمي" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevRio:get(ZAEM..'Rio:Anime:Rio'..msg.chat_id_) ZAEMthen
...
--     Source ZAEM     --
if text == "تفعيل فلم" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ᥀") and not DevRio:get(ZAEM..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source ZAEM     --
if text == "تفعيل مسلسل" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) ZAEMthen
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(ZAEM..'Rio:Series:Rio'..msg.chat_id_) ZAEMthen
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SeriesZAEM/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source ZAEM     --
if Admin(msg) then
if DevRio:get(ZAEM..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevRio:get(ZAEM..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevRio:get(ZAEM..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevRio:get(ZAEM..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الملصقات" then if DevRio:get(ZAEM..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الصور" then if DevRio:get(ZAEM..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevRio:get(ZAEM..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الاونلاين" then if DevRio:get(ZAEM..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local ZAEMTeam = "\n" .."᥀︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الدردشه" then if DevRio:get(ZAEM..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevRio:get(ZAEM..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local ZAEMTeam = "\n" .."᥀︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الاغاني" then if DevRio:get(ZAEM..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevRio:get(ZAEM..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local ZAEMTeam = "\n" .."᥀︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevRio:get(ZAEM..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الماركداون" then if DevRio:get(ZAEM..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local ZAEMTeam = "\n" .."᥀︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الهاشتاك" then if DevRio:get(ZAEM..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local ZAEMTeam = "\n" .."᥀︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "التعديل" then if DevRio:get(ZAEM..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local ZAEMTeam = "\n" .."᥀︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "التثبيت" then if DevRio:get(ZAEM..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local ZAEMTeam = "\n" .."᥀︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الاشعارات" then if DevRio:get(ZAEM..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الكلايش" then if DevRio:get(ZAEM..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الدخول" then if DevRio:get(ZAEM..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local ZAEMTeam = "\n" .."᥀︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الشبكات" then if DevRio:get(ZAEM..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "المواقع" then if DevRio:get(ZAEM..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "العربيه" then if DevRio:get(ZAEM..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(ZAEM..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local ZAEMTeam = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الكفر" then if DevRio:get(ZAEM..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local ZAEMTeam = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الفشار" then if DevRio:get(ZAEM..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local ZAEMTeam = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(ZAEM..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local ZAEMTeam = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ZAEMTeam, 1, 'md') end
end
--     Source ZAEM     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source ZAEM     --
if text == 'تفعيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل اوامر التحشيش'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اوامر التحشيش'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:Stupid'..msg.chat_id_,true)
end
--     Source ZAEM     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source ZAEM     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source ZAEM     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source ZAEM     --
if SecondSudo(msg) then
...
--     Source ZAEM     --
if msg.content_.photo_ then
if DevRio:get(ZAEM..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevRio:del(ZAEM..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"᥀︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevRio:del(ZAEM..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(ZAEM..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source ZAEM     --
...
if data.ID == "Ok" then
DevRio:del(ZAEM..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevRio:get(ZAEM..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevRio:del(ZAEM..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevRio:scard(ZAEM.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevRio:scard(ZAEM.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevRio:scard(ZAEM.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevRio:scard(ZAEM.."Rio:Managers:"..ChatId) or 0
local MutedList = DevRio:scard(ZAEM.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevRio:scard(ZAEM.."Rio:Rio:Tkeed:"..ChatId) or 0
local AdminsList = DevRio:scard(ZAEM.."Rio:Admins:"..ChatId) or 0
local VipList = DevRio:scard(ZAEM.."Rio:VipMem:"..ChatId) or 0
...
ChatLeave(dp.id_, ZAEM)
DevRio:srem(ZAEM.."Rio:Groups", dp.id_)
else
...
DevRio:set(ZAEM..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:FreeBot'..ZAEM) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:FreeBot'..ZAEM,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ZAEM.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ZAEM.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(ZAEM.."Rio:Groups",msg.chat_id_)
if not DevRio:get(ZAEM..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevRio:incrby(ZAEM..'Rio:Sudos'..msg.sender_user_id_,1)
DevRio:set(ZAEM..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevRio:sismember(ZAEM..'Rio:Groups',msg.chat_id_) then
...
local Text = "᥀︙Source ZAEM\n᥀︙File Bot Groups\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local GroupsManagers = DevRio:scard(ZAEM.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevRio:scard(ZAEM.."Rio:Admins:"..v) or 0
local Groupslink = DevRio:get(ZAEM.."Rio:Groups:Links" ..v)
...
DevRio:setex(ZAEM.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ZAEM.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ZAEM.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(ZAEM..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevRio:setex(ZAEM.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ZAEM.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ZAEM.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(ZAEM..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevRio:setex(ZAEM.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ZAEM.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ZAEM.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(ZAEM..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevRio:setex(ZAEM.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ZAEM.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ZAEM.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(ZAEM..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevRio:setex(ZAEM.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ZAEMTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZAEMTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ZAEM.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ZAEM.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevRio:smembers(ZAEM.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevRio:set(ZAEM..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevRio:set(ZAEM..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(ZAEM..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(ZAEM..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(ZAEM..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(ZAEM..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(ZAEM..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevRio:set(ZAEM..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
local List = DevRio:smembers(ZAEM..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end
DevRio:set(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevRio:get(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevRio:sismember(ZAEM..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevRio:set(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevRio:set(ZAEM..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevRio:set(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text == 'اضف رد متعدد' and Manager(msg) and ChCheck(msg) then
DevRio:set(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRedod = DevRio:get(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(ZAEM..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevRio:set(ZAEM..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(ZAEM..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source ZAEM     --
if text == 'حذف رد' and Manager(msg) and ChCheck(msg) or text == 'مسح رد' and  Manager(msg) and ChCheck(msg) then
local List = DevRio:smembers(ZAEM..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevRio:set(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد' and not DevRio:get(ZAEM..'Rio:Lock:Rd'..msg.chat_id_) and Manager(msg) and ChCheck(msg) then
DevRio:set(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(ZAEM..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevRio:set(ZAEM..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(ZAEM..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevRio:set(ZAEM..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source ZAEM     --
...
local List = DevRio:smembers(ZAEM.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevRio:set(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevRio:set(ZAEM.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevRio:set(ZAEM.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevRio:sadd(ZAEM.."Rio:Sudo:AllRed",text)
DevRio:set(ZAEM.."DelSudoRep",text)
return false 
end end
--     Source ZAEM     --
if text == 'الردود المتعدده' and Manager(msg) and ChCheck(msg) then
local redod = DevRio:smembers(ZAEM..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '᥀︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(ZAEM..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
for k,v in pairs(redod) do
DevRio:del(ZAEM..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevRio:smembers(ZAEM..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '᥀︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(ZAEM.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevRio:get(ZAEM.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevRio:get(ZAEM.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevRio:get(ZAEM.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevRio:get(ZAEM.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevRio:get(ZAEM.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevRio:get(ZAEM.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevRio:get(ZAEM.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
if Manager(msg) then
if text and (text =='حذف الردود' or text == 'مسح الردود' or text == 'حذف ردود المدير' or text == 'مسح ردود المدير') and not DevRio:get(ZAEM..'Rio:Lock:Rd'..msg.chat_id_) and ChCheck(msg) then
local redod = DevRio:smembers(ZAEM..'Rio:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
else
for k,v in pairs(redod) do
DevRio:del(ZAEM..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Video:GpRed'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:File:GpRed'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Text:GpRed'..v..msg.chat_id_)
DevRio:del(ZAEM..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevRio:smembers(ZAEM.."Rio:Sudo:AllRed")
MsgRep = '᥀︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(ZAEM.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevRio:get(ZAEM.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevRio:get(ZAEM.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevRio:get(ZAEM.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevRio:get(ZAEM.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevRio:get(ZAEM.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevRio:get(ZAEM.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevRio:get(ZAEM.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevRio:del(ZAEM.."Rio:Add:AllRed"..v)
DevRio:del(ZAEM.."Rio:Gif:AllRed"..v)
DevRio:del(ZAEM.."Rio:Voice:AllRed"..v)
DevRio:del(ZAEM.."Rio:Audio:AllRed"..v)
DevRio:del(ZAEM.."Rio:Photo:AllRed"..v)
DevRio:del(ZAEM.."Rio:Stecker:AllRed"..v)
DevRio:del(ZAEM.."Rio:Video:AllRed"..v)
DevRio:del(ZAEM.."Rio:File:AllRed"..v)
DevRio:del(ZAEM.."Rio:Text:AllRed"..v)
DevRio:del(ZAEM.."Rio:Sudo:AllRed")
end
...
DevRio:set(ZAEM..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevRio:set(ZAEM..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZAEMTeam =  DevRio:get(ZAEM..'Rio:Help0'..msg.sender_user_id_)
if ZAEMTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ZAEM..'Rio:Help0'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ZAEM..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZAEMTeam =  DevRio:get(ZAEM..'Rio:Help01'..msg.sender_user_id_)
if ZAEMTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ZAEM..'Rio:Help01'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ZAEM..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZAEMTeam =  DevRio:get(ZAEM..'Rio:Help21'..msg.sender_user_id_)
if ZAEMTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ZAEM..'Rio:Help21'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ZAEM..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZAEMTeam =  DevRio:get(ZAEM..'Rio:Help31'..msg.sender_user_id_)
if ZAEMTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ZAEM..'Rio:Help31'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ZAEM..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZAEMTeam =  DevRio:get(ZAEM..'Rio:Help41'..msg.sender_user_id_)
if ZAEMTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ZAEM..'Rio:Help41'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevRio:set(ZAEM..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZAEMTeam =  DevRio:get(ZAEM..'Rio:Help51'..msg.sender_user_id_)
if ZAEMTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ZAEM..'Rio:Help51'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ZAEM..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZAEMTeam =  DevRio:get(ZAEM..'Rio:Help61'..msg.sender_user_id_)
if ZAEMTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ZAEM..'Rio:Help61'..msg.sender_user_id_)
DevRio:set(ZAEM..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
--     Source ZAEM     --
if SecondSudo(msg) then
if text == "تحديث السورس" or text == "تحديث سورس" or text == "↫ تحديث السورس ᥀" ZAEMthen 
...
if text == 'تحديث' or text == 'تحديث البوت' or text == '↫ تحديث ᥀' ZAEMthen  
dofile('ZAEM.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
local Users = DevRio:smembers(ZAEM.."User_Bot")
local Groups = DevRio:smembers(ZAEM..'Chek:Groups')
local Sudos = DevRio:smembers(ZAEM.."Sudo:User")
if DevRio:get(ZAEM..'Name:Bot') then
DevRio:set(ZAEM..'Rio:NameBot',(DevRio:get(ZAEM..'Name:Bot') or 'ديفد'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevRio:sadd(ZAEM..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevRio:sadd(ZAEM..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevRio:sadd(ZAEM..'Rio:Groups',Groups[i]) 
if DevRio:get(ZAEM.."Private:Group:Link"..Groups[i]) then
DevRio:set(ZAEM.."Rio:Groups:Links"..Groups[i],DevRio:get(ZAEM.."Private:Group:Link"..Groups[i]))
end
if DevRio:get(ZAEM.."Get:Welcome:Group"..Groups[i]) then
DevRio:set(ZAEM..'Rio:Groups:Welcomes'..Groups[i],DevRio:get(ZAEM.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevRio:smembers(ZAEM..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevRio:sadd(ZAEM.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevRio:smembers(ZAEM..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevRio:sadd(ZAEM.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevRio:smembers(ZAEM..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevRio:sadd(ZAEM.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevRio:smembers(ZAEM..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevRio:sadd(ZAEM.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevRio:smembers(ZAEM..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevRio:sadd(ZAEM.."Rio:VipMem:"..Groups[i], v)
end
DevRio:set(ZAEM.."Rio:Lock:Bots"..Groups[i],"del") DevRio:hset(ZAEM.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevRio:set(ZAEM..Lock..Groups[i],true)
end
end
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/bZAEM2019/ZAEMFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/bZAEM2019/ZAEMFiles/master/ZAEMFiles/"..FileName)
if Res == 200 then
...
DevRio:del(ZAEM..'Rio:Text:BotWelcome')
DevRio:del(ZAEM..'Rio:Photo:BotWelcome')
return false
end 
...
DevRio:del(ZAEM..'Rio:Lock:BotWelcome')
return false
end 
...
DevRio:set(ZAEM..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevRio:del(ZAEM..'Rio:Text:BotWelcome')
DevRio:del(ZAEM..'Rio:Photo:BotWelcome')
DevRio:set(ZAEM.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevRio:get(ZAEM.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(ZAEM.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ النص ارسل لي صورة الترحيب\n᥀︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevRio:set(ZAEM.."Rio:Text:BotWelcome",text) 
DevRio:set(ZAEM.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevRio:get(ZAEM.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevRio:set(ZAEM.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevRio:setex(ZAEM.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevRio:del(ZAEM.."DevText")
end end
--     Source ZAEM     --
if DevRio:get(ZAEM.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(ZAEM.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del(ZAEM.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevRio:set(ZAEM..'Rio:ChText',texxt)
...
DevRio:setex(ZAEM.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
--     Source ZAEM     --
if text == 'القناة' or text == 'قناة السورس' or text == 'قناه السورس' or text == 'قنات السورس' or text == '↫ قناة السورس ᥀' ZAEMthen 
Text = [[
...
DevRio:incr(ZAEM..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevRio:get(ZAEM..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not SecondSudo(result) then
...
local GetMsgPin = DevRio:get(ZAEM..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevRio:del(ZAEM..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevRio:del(ZAEM..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=ZAEM,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevRio:srem(ZAEM..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevRio:srem(ZAEM..'Rio:Groups',v)  
end
